...
public class CouponControllerTest {
    ...
    @Test
    @DisplayName("유저 본인이 보유한 쿠폰 목록 조회")
    @WithMockCustomUser(role = "ROLE_SELLER")
    public void couponListUser() {
        ...
        Response resp = given(this.spec)
            ...
            .filter(document("coupon-controller/coupon-list-user",
        ...
        Response resp = given(this.spec)
            ...
            .filter(document("coupon-controller/coupon-list-seller",
                    ...
                    responseFields(
                        ...
                        fieldWithPath("data.content.[].expiresAt").type(JsonFieldType.STRING)
                        .description("만료일자"),
                        fieldWithPath("data.content.[].datail").type(JsonFieldType.STRING)
